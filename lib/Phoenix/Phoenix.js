...
var Phoenix = /** @class */ (function (_super) {
    ...
    Phoenix.prototype.createPowerString = function (arr) {
        var powerString = "";
    ...
    Phoenix.prototype.listPowers = function () {
        console.log("Phoenix, played by " + this.username + " has abilities " + this.createPowerString(this.powers) + ", and his ultimate is " + this.ulti);
    };
    return Phoenix;
}(Player_1["default"]));
